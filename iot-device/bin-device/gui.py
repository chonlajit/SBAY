...
class SmartBinGUI:
    ...
    def __init__(self, on_phone_submit, on_finish):
        ...
        self.root.geometry("800x480")  # Official Pi Touchscreen resolution
        ...
        self.font_large = tkfont.Font(family="Helvetica", size=22, weight="bold")
        self.font_medium = tkfont.Font(family="Helvetica", size=16)
        self.font_small = tkfont.Font(family="Helvetica", size=12)
        self.font_keypad = tkfont.Font(family="Helvetica", size=20, weight="bold")
    ...
    def show_idle(self):
        ...
        # Logo / Icon
        tk.Label(frame, text="♻️", font=("Segoe UI Emoji", 60), bg=self.BG).pack()
    ...
    def show_welcome(self, name):
        ...
        tk.Label(
            frame, text="👋", font=("Segoe UI Emoji", 48), bg=self.BG
        ).pack()
    ...
    def show_detecting(self):
        ...
        # Top bar
        top = tk.Frame(self.container, bg=self.GREEN_DARK, height=50)
        top.pack(fill="x")
        ...
        bottom = tk.Frame(self.container, bg=self.BG, height=70)
    ...
    def show_result(self, total_items, total_ml, total_score, success=True):
        ...
        if success:
            tk.Label(frame, text="✅", font=("Segoe UI Emoji", 48), bg=self.BG).pack()
            tk.Label(
