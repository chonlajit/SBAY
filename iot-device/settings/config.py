...
ML_RANGES = [
    ...
    (0, 225, 170),      # กระป๋องกาแฟ 170ml / กล่องนมเล็ก
    (225, 275, 250),    # กระป๋อง 240-250ml
    (275, 312, 300),    # 300ml
    (312, 380, 325),    # กระป๋องน้ำอัดลม 325ml / 330ml
    (380, 440, 350),    # ขวดน้ำดื่มมินิ / ชาเขียวมินิ 350ml
    (440, 575, 500),    # ขวดชาเขียวโออิชิ/อิชิตัน 500ml, น้ำอัดลม 450-500ml
    (575, 800, 600),    # ขวดน้ำดื่มมาตรฐาน 550ml - 600ml (คริสตัล, ช้าง, สิงห์, เนสท์เล่)
