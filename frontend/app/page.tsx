                ...
                <div className="relative max-w-lg md:max-w-4xl mx-auto">
                    <div className="flex items-center space-x-3 mb-4">
                        ...
                        <div>
                            ...
                            <p className="text-green-200 text-xs">Smart Recycling Platform</p>
                        </div>
                    </div>
                    ...
                    <>
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            {[
                                ...
                                { icon: <i className="fa-solid fa-star text-yellow-400"></i>, label: 'สะสมแต้ม', sub: 'ทุกครั้ง' },
                                { icon: <i className="fa-solid fa-gift text-red-400"></i>, label: 'แลกกิจกรรม', sub: 'ง่ายดาย' },
                            ].map((f, i) => (
